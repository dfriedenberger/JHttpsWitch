...
public class TestTrackingImpl {

	@Test
	public void test() {
		
		TrackingQueue queue = mock(TrackingQueue.class);
		Anonymizer anonymizer = mock(Anonymizer.class);
		Tracking tracking = new TrackingImpl(queue, anonymizer);
		
		tracking.busyConnectionPoolEvent();
		
		verify(queue).enqueue(any(TrackingPoint.class));
